...
const TrustIndicators = () => {
  return (
    <div className="bg-gradient-to-r from-[#092b55] via-[#164b8b] to-[#092b55] text-white py-8 md:py-12 lg:py-15 my-6 md:my-8 lg:my-10 max-w-[95%] md:max-w-4xl lg:max-w-7xl mx-auto rounded-2xl flex items-center justify-center flex-col md:flex-row flex-wrap gap-4 md:gap-8 lg:gap-12">
      <div className="w-full text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-medium px-4">
          Trusted by over 6K+ customers
        </h2>

        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-20 py-6 items-center">
          <div className="flex gap-3 text-left md:gap-4 ">
            <div className="bg-white rounded-full p-3 md:p-4">
              <svg
                width="32"
                height="32"
                className="w-8 h-8 md:w-10 md:h-10 lg:w-[42px] lg:h-[42px]"
              ...
              >
                <defs>
                  <clipPath id="clip243_122">
                    <rect width="42.020203" height="42.020203" fill="white" fill-opacity="0" />
                  </clipPath>
                </defs>
                <rect width="42.020203" height="42.020203" fill="#FFFFFF" fill-opacity="0" />
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-[28px] font-normal">
              <span className="font-medium">Premium</span><br /> Products
            </p>
          </div>
          ...
          <div className="flex gap-3 text-left md:gap-4">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-[28px] font-normal">
              <span className="font-medium">4000+</span><br /> Google Review
            </p>
          </div>
          ...
          <div className="flex gap-3 text-left md:gap-4 ">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-[28px] font-normal">
              <span className="font-medium">Delivery</span><br />Across India
            </p>
          </div>
        </div>
      </div>
